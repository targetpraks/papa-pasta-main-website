    ...
    <section className="section-padding bg-pp-navy text-pp-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-pp-white font-serif text-3xl sm:text-4xl font-bold mb-6 leading-tight">
          ...
          <a
            href="/story/"
            className="inline-flex items-center rounded-md bg-pp-gold px-6 py-2.5 text-sm font-semibold text-pp-navy hover:bg-pp-gold-light transition"
          >
            Read Our Story
          </a>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={loc.city} className="bg-white rounded-xl overflow-hidden shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {posts.map((post) => (
            <a
              key={post.title}
              href="/blog/"
              className="group block bg-pp-cream rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition"
            >
              <div className="aspect-[16/10] overflow-hidden">
              ...
              <div className="p-6">
                ...
                <h3 className="text-pp-navy font-serif text-lg font-semibold mb-3 group-hover:text-pp-gold transition">{post.title}</h3>
    ...
    <section className="section-padding bg-pp-navy text-pp-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-8">
            <a href="/events/" className="inline-flex items-center rounded-md bg-pp-gold px-6 py-2.5 text-sm font-semibold text-pp-navy hover:bg-pp-gold-light transition">
              View All Events
            </a>
          </div>
        </div>
