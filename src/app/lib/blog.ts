...
export const blogPosts: BlogPost[] = [
  {
    slug: "heritage-bowl-youth-day-drop",
    title: "Heritage Bowl Launch Drops on Youth Day",
    date: "16 June 2026",
    ...
    ctaHref: "/loyalty/",
    dropMeta: "500 units · Loyalty window opens first",
    content: "<p>The Heritage Bowl collection is built for customers who treat their pasta bowl like a badge. The drop opens on Youth Day with 500 numbered pieces and a loyalty early-access window before public release.</p><p>Members will see the collection preview first, then stores will open public claim windows while stock lasts.</p>",
  },
  {
    slug: "cbd-gardens-store-launch",
    title: "CBD Gardens Store Launch",
    date: "July 2026",
    ...
    ctaHref: "/locations/",
    dropMeta: "Cape Town · Launch offer to be announced",
    content: "<p>The next Cape Town zone is loading. The Gardens launch will include a first-week opening offer, in-store loyalty signup, and a limited bowl allocation for launch-day visitors.</p><p>Follow the locations page for the confirmed opening day, delivery availability, and launch queue details.</p>",
  },
  {
    slug: "blackout-bomber-live",
    title: "Blackout Bomber Jacket Is Live",
    date: "June 2026",
    ...
    ctaLabel: "Shop Merch",
    ctaHref: "/merch/",
    dropMeta: "Live now · XS-XXL",
    content: "<p>The Blackout Bomber is the first Papa Pasta jacket built for the cyber crest era: satin shell, reflective mark, and black-on-black finish until the light hits.</p><p>Sizes are limited and will not be restocked in the same configuration.</p>",
  },
  {
    slug: "level-up-loyalty-loading",
    title: "Level Up Loyalty Is Loading",
    date: "June 2026",
    ...
    ctaLabel: "Join Loyalty",
    ctaHref: "/loyalty/",
    dropMeta: "Waitlist open · Early access rewards",
    content: "<p>Level Up connects the whole Papa Pasta universe: orders, merch drops, launch events, and limited collections.</p><p>The first member benefits include birthday pasta rewards, drop alerts, early access windows, and launch invites.</p>",
  },
  {
  ...
  },
  {
    ...
    ctaLabel: "Visit Franchise Site",
    ctaHref: "https://franchise.papapasta.co.za/",
